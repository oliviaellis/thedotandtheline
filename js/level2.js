...
level2.prototype = {
    ...
    create: function () {
      ...
      // create Line sprite
        line1 = this.game.add.sprite(100, 0, 'whiteline');
        line2 = this.game.add.sprite(100, 300, 'whiteline');
    ...
    initEnemies: function(){
      // Create 5 enemies with speed -300 (toward left of screen)
        for(var i = 0; i <= 5; i++){
            var sprite = this.enemies.create(800, 100, 'whiteballs', null, false);
